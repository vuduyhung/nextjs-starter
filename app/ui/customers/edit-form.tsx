...
import { Customer, CustomerField, InvoiceForm } from '@/app/lib/definitions';
import {
  CheckIcon,
  ClockIcon,
  CurrencyDollarIcon,
...
export default function EditFormCustomer({ customer }: { customer: Customer }) {
          ...
          <div className="relative mt-2 rounded-md">
            <div className="relative">
              <input
                ...
                type="text"
                placeholder="Enter Customer's Image url"
                className="peer block w-full rounded-md border border-gray-200 py-2 pl-10 text-sm outline-2 placeholder:text-gray-500"
